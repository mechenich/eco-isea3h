...
inputfolder = "%s/Ecosphere/Datasets/NE10M_V040100" % (z)
inputfield = "featurecla"

outputfolder = "%s/Ecosphere/ISEA3H%02i/NE10M_V040100/Working"
...
for species in speciesfiles:
    ...
    if os.path.exists(outputfile) == False:
        os.mkdir(outputfile)
        outputfile = "%s/ISEA3H%02i_%s" % (outputfile, resolution, species)
